...
apptainer run --nv -B /temp/camelyon17_unlabeled_v1.0.sqfs:/data/camelyon17_unlabeled_v1.0:image-src=/,/temp/camelyon17_v1.0.sqfs:/data/camelyon17_v1.0:image-src=/ ../../containers/main/main.sif \
    python train.py \
        --config-name base